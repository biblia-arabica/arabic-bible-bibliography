{
	"translatorID": "032ae9b7-ab90-9205-a479-baf81f49184a-z",
	"translatorType": 2,
	"label": "TEI with abstract",
	...
	"lastUpdated": "2017-09-30 15:37:00"
}
...
function generateItem(item, teiDoc) {
    ...
    //Attempting to export abstract
    if (item.abstractNote) {
		var note = teiDoc.createElementNS(ns.tei, "note");
		note.setAttribute("type", "abstract");
		note.appendChild(teiDoc.createTextNode(item.abstractNote));
		bibl.appendChild(note);
    }
